...
def test_6(page: Page):
    ...
    PAGINA.seleccionar_revisor("Revisor Vacaciones")
    PAGINA.ingresar_descripcion("descripcion solicitud")
    PAGINA.guardar_datos()
    PAGINA.verificar_guardado("test_1")
...
def test_9(page: Page):
    ...
    PAGINA.ingresar_descripcion("descripcion solicitud")
    PAGINA.guardar_datos()
    PAGINA.verificar_error_modal("Debes seleccionar una fecha de inicio.")
...
def test_21(page: Page):
    ...
    PAGINA.ingresar_descripcion("descripcion solicitud")
    PAGINA.guardar_datos()
    PAGINA.verificar_error_no_revisor()
    page.screenshot(path="screenshots/test_20.png")
...
def test_23(page: Page):
    ...
    PAGINA.seleccionar_usuario("David Diaz")
    PAGINA.seleccionar_tipo_dia_libre("Baja por enfermedad")
    PAGINA.seleccionar_fecha_inicio("08/04/2025", "Mañana")
    PAGINA.seleccionar_fecha_fin("09/04/2025", "Tarde")
    PAGINA.seleccionar_revisor("Revisor Vacaciones")
...
def test_24(page: Page):
    ...
    PAGINA.seleccionar_usuario("David Diaz")
    PAGINA.seleccionar_tipo_dia_libre("Baja por enfermedad")
    PAGINA.seleccionar_fecha_inicio("10/04/2025", "Mañana")
    PAGINA.seleccionar_fecha_fin("11/04/2025", "Tarde")
    PAGINA.seleccionar_revisor("Revisor Vacaciones")
    PAGINA.ingresar_descripcion("OR TRUE;; DROP DATABASE dolidb;")
    PAGINA.guardar_datos()
    PAGINA.verificar_error_modal("El campo 'descripcion solicitud' no es válido.")
    page.screenshot(path="screenshots/test_24.png")

def test_25(page: Page):
    PAGINA = CrearDiaLibrePage(page, URL)
    PAGINA.seleccionar_usuario("David Diaz")
    PAGINA.seleccionar_tipo_dia_libre("Baja por enfermedad")
    PAGINA.seleccionar_fecha_inicio("15/04/2025", "Mañana")
    PAGINA.seleccionar_fecha_fin("16/04/2025", "Tarde")
    PAGINA.seleccionar_revisor("Revisor Vacaciones")
    PAGINA.ingresar_descripcion("a"*291)
    PAGINA.guardar_datos()
    PAGINA.verificar_error_modal("El campo 'descripcion solicitud' es muy largo.")

def test_26(page: Page):
    PAGINA = CrearDiaLibrePage(page, URL)
    PAGINA.seleccionar_usuario("David Diaz")
    PAGINA.seleccionar_tipo_dia_libre("Baja por enfermedad")
    PAGINA.seleccionar_fecha_fin("25/03/2025", "Mañana")
    PAGINA.seleccionar_revisor("Revisor Vacaciones")
    PAGINA.ingresar_descripcion("descripcion solicitud")
    PAGINA.guardar_datos()
